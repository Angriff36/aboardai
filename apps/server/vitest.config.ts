...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@aboardai/utils': path.resolve(__dirname, '../../libs/utils/src/index.ts'),
      '@aboardai/platform': path.resolve(__dirname, '../../libs/platform/src/index.ts'),
      '@aboardai/types': path.resolve(__dirname, '../../libs/types/src/index.ts'),
      '@aboardai/model-resolver': path.resolve(
        __dirname,
        '../../libs/model-resolver/src/index.ts'
      ),
      '@aboardai/dependency-resolver': path.resolve(
        __dirname,
        '../../libs/dependency-resolver/src/index.ts'
      ),
      '@aboardai/git-utils': path.resolve(__dirname, '../../libs/git-utils/src/index.ts'),
    },
  },
});
