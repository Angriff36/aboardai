...
## Project DNA: @aboardai/server

Stack: TypeScript
Style: [unknown]
Structure: data, src, test, tests
Deploy: [NOT SET]
Active: [new session]
Last: [first session]
...
[auto-bridge from orphan cleanup]
Files: C:/projects/aboardai/docs/superpowers/plans/2026-06-14-reference-repo-audit-roadmap.md (edit)
