...
import { ensureAboardAIDir, getAboardAIDir } from '@aboardai/platform';
import * as secureFs from '../../lib/secure-fs.js';
import path from 'path';
import type { BacklogPlanResult } from '@aboardai/types';
...
function getBacklogPlanPath(projectPath: string): string {
  return path.join(getAboardAIDir(projectPath), BACKLOG_PLAN_FILENAME);
}
