...
import { getClaudeCliPaths, getClaudeAuthIndicators, systemPathAccess } from '@aboardai/platform';
...
function isDisconnectedFromApp(): boolean {
  try {
    ...
    const markerPath = path.join(projectRoot, '.aboardai', DISCONNECTED_MARKER_FILE);
