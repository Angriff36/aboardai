...
export type { SpecOutput } from '@aboardai/types';
export { specOutputSchema } from '@aboardai/types';
 ...
 */
export function specToXml(spec: import('@aboardai/types').SpecOutput): string {
  const indent = '  ';
