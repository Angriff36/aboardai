 ...
 * {projectPath}/.aboardai/notifications.json
 *
...
import { getNotificationsPath, ensureAboardAIDir } from '@aboardai/platform';
import type { Notification, NotificationsFile, NotificationType } from '@aboardai/types';
import { DEFAULT_NOTIFICATIONS_FILE } from '@aboardai/types';
