...
import { DEFAULT_IDEATION_CONTEXT_SOURCES, type IdeationContextSources } from '@aboardai/types';
...
const IDEATION_CONTEXT_OPTIONS: Array<{
  ...
  },
  {
    key: 'useContextFiles',
    label: 'Context Files',
    description: '.aboardai/context/*.md|.txt',
    icon: FileText,
  },
  {
    key: 'useMemoryFiles',
    label: 'Memory Files',
    description: '.aboardai/memory/*.md',
    icon: Brain,
  },
  {
