 ...
 *
 * Provides a shared utility to load context files from .aboardai/context/
 * and memory files from .aboardai/memory/, formatting them as system prompt
 ...
 * Stored in {projectPath}/.aboardai/context/context-metadata.json
 */
...
/**
 * Memory file info (from .aboardai/memory/)
 */
 ...
 * Compatible with secureFs from @aboardai/platform
...
export interface LoadContextFilesOptions {
  ...
  /** Whether to include context files from .aboardai/context/ (default: true) */
  includeContextFiles?: boolean;
  /** Whether to include memory files from .aboardai/memory/ (default: true) */
...
function getContextDir(projectPath: string): string {
  return path.join(projectPath, '.aboardai', 'context');
}
...
/**
 * Load context files from a project's .aboardai/context/ directory
 * and optionally memory files from .aboardai/memory/
 *
