...
AI prompt templates for text enhancement and other AI-powered features in AboardAI.
...
```typescript
import { getSystemPrompt } from '@aboardai/prompts';
...
```typescript
import { getExamples } from '@aboardai/prompts';
...
```typescript
import { buildUserPrompt } from '@aboardai/prompts';
...
```typescript
import { isValidEnhancementMode } from '@aboardai/prompts';
...
```typescript
import { getAvailableEnhancementModes } from '@aboardai/prompts';
...
```typescript
import { isValidEnhancementMode, getAvailableEnhancementModes } from '@aboardai/prompts';
...
```typescript
import { getSystemPrompt, buildUserPrompt, getExamples } from '@aboardai/prompts';
...
- `@aboardai/types` - Type definitions for EnhancementMode and EnhancementExample

## Used By

- `@aboardai/server` - Enhancement API routes
